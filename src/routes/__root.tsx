...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "A Russian-language landing page for \"Wild Trails\" travel agency, offering adventure tours across Russia." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "A Russian-language landing page for \"Wild Trails\" travel agency, offering adventure tours across Russia." },
